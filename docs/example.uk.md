...
- [Модуль `jizhak.reduction`](reduction_example.uk.md)
- [Модуль `jizhak.error`](error_example.uk.md)
- [Модуль `jizhak.thread_pool`](tp_example.uk.md)

**Переглянути приклад можна у файлі [`main_example.cpp`](../example/main_example.cpp).**